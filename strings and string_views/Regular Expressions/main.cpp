...
int main() {
    ...
    regex r3{"[A-Z][a-z]*"};
    cout << "Matching against: [A-Z][a-z]*" << "\n" << format("Angel: {}; tina: {}\n\n", regex_match("Angel", r3), regex_match("tina", r3));
    ...
    regex r6{"[A-Z][a-z]+"};
    cout << "Matching against: [A-Z][a-z]+" << "\n" << format("Angel: {}; T: {}\n\n", regex_match("Angel", r6), regex_match("T", r6));
    
    regex r7{"labell?ed:"};
    cout << "Matching against: labell?ed\n" << format("labelled: {}; labeled: {}; labellled: {}\n\n", regex_match("labelled", r7), regex_match("labeled", r7), regex_match("labellled", r7));
    
    regex r8{R"(\d{3,})"};
    cout << R"(Matching against: \d{3,})" << "\n" << format("123: {}; 1234567890: {}; 12: {}\n\n", regex_match("123", r8), regex_match("1234567890", r8), regex_match("12", r8));
    
    regex r9{R"(\d{3,6})"};
    cout << R"(Matching against: \d{3,6})" << "\n" << format("123: {}; 123456: {}; 1234567: {}; 12: {}\n\n", regex_match("123", r8), regex_match("123456", r9), regex_match("1234567", r9), regex_match("12", r9));
}
